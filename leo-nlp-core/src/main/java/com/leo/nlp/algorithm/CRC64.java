...
public class CRC64 {
    ...
    public static void main(String[] args) {
        String str = "89760115$鸡腿的酱料非常入味，配上蛋羹和排骨汤，吃的饱饱的！";
        System.out.println(digest(str.getBytes()));
        str = "275416526$还有胸口油、吊龙伴、限量供应的五花趾，好吃到飞起?";
        System.out.println(digest(str.getBytes()));
        str = "89760115$鸡腿的酱料非常入味，配上蛋羹和排骨汤，吃的饱饱的！";
        System.out.println(digest(str.getBytes()));
    }
}
